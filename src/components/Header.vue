<template>
  <div class="header">
    <div class="sidebar-is-reduced" v-bind:class='{"sidebar-is-expanded":sidebarExpanded}'>
      <header class="l-header">
        <div class="l-header__inner clearfix">
          <div class="c-header-icon js-hamburger">
            <div class="hamburger-toggle" v-on:click='expandMenu()' v-bind:class='{"is-opened":sidebarExpanded}'><span class="bar-top"></span><span class="bar-mid"></span><span class="bar-bot"></span></div>
          </div>
          <div class="c-header-icon has-dropdown"><span class="c-badge c-badge--header-icon">87</span><icon name="bell" scale="1.5"></icon>
...
<script>
  export default {
    ...
    methods: {
      ...
      toggleTile(event) {
        const menus = event.currentTarget.parentNode.querySelectorAll(':scope > li');
        /* eslint-disable */
        this.$_.forEach(menus, function (menu) {
          menu.className = 'c-menu__item';
        });
        event.currentTarget.className = 'c-menu__item is-active';
        /* eslint-enable */
      },
    },
  };
